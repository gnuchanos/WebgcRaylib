...
Module['FS_createPath']("/resources", "3D", true, true);
...
Module['FS_createPath']("/resources", "Texture", true, true);
    ...
    loadPackage({"files": [{"filename": "/resources/3D/tutorialCharachter0.glb", "start": 0, "end": 440960}, {"filename": "/resources/3D/tutorialCharachter0.m3d", "start": 440960, "end": 487941}, {"filename": "/resources/Font/FreeSans.ttf", "start": 487941, "end": 752013}, {"filename": "/resources/Font/OpenSans-Italic.ttf", "start": 752013, "end": 1332293}, {"filename": "/resources/Font/OpenSans.ttf", "start": 1332293, "end": 1861993}, {"filename": "/resources/Font/Sans.ttf", "start": 1861993, "end": 2391693}, {"filename": "/resources/Sound/hitSound.wav", "start": 2391693, "end": 2423482, "audio": 1}, {"filename": "/resources/Sound/music.mp3", "start": 2423482, "end": 5425063, "audio": 1}, {"filename": "/resources/Sound/point.wav", "start": 5425063, "end": 5496596, "audio": 1}, {"filename": "/resources/Texture/bg.png", "start": 5496596, "end": 5586657}, {"filename": "/resources/Texture/logo.png", "start": 5586657, "end": 5634981}], "remote_package_size": 5634981});

  })();

// end include: /tmp/tmp024js6xx.js
// include: /tmp/tmpns3jg8lv.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpns3jg8lv.js
// include: /tmp/tmpad2t534s.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpad2t534s.js
...
var ASM_CONSTS = {
  67163608: () => { if (document.fullscreenElement) return 1; },  
 67163654: () => { return Module.canvas.width; },  
 67163686: () => { return parseInt(Module.canvas.style.width); },  
 67163734: () => { document.exitFullscreen(); },  
 67163761: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 67163834: () => { if (document.fullscreenElement) return 1; },  
 67163880: () => { return Module.canvas.width; },  
 67163912: () => { return screen.width; },  
 67163937: () => { document.exitFullscreen(); },  
 67163964: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 67164097: () => { return window.innerWidth; },  
 67164123: () => { return window.innerHeight; },  
 67164150: () => { if (document.fullscreenElement) return 1; },  
 67164196: () => { return Module.canvas.width; },  
 67164228: () => { return parseInt(Module.canvas.style.width); },  
 67164276: () => { if (document.fullscreenElement) return 1; },  
 67164322: () => { return Module.canvas.width; },  
 67164354: () => { return screen.width; },  
 67164379: () => { return window.innerWidth; },  
 67164405: () => { return window.innerHeight; },  
 67164432: () => { if (document.fullscreenElement) return 1; },  
 67164478: () => { return Module.canvas.width; },  
 67164510: () => { return screen.width; },  
 67164535: () => { document.exitFullscreen(); },  
 67164562: () => { if (document.fullscreenElement) return 1; },  
 67164608: () => { return Module.canvas.width; },  
 67164640: () => { return parseInt(Module.canvas.style.width); },  
 67164688: () => { document.exitFullscreen(); },  
 67164715: ($0) => { Module.canvas.style.opacity = $0; },  
 67164753: () => { return screen.width; },  
 67164778: () => { return screen.height; },  
 67164804: () => { return window.screenX; },  
 67164831: () => { return window.screenY; },  
 67164858: () => { return window.devicePixelRatio; },  
 67164894: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 67164947: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 67164998: () => { Module.canvas.style.cursor = 'none'; },  
 67165035: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 67165291: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 67165342: () => { if (document.fullscreenElement) return 1; },  
 67165388: () => { return window.innerWidth; },  
 67165414: () => { return window.innerHeight; },  
 67165441: () => { if (document.pointerLockElement) return 1; }
};
