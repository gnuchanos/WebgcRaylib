...
int main() {
	...
	Button StartButton = CreateButton("This Is My Kingdom COME This Is My Kingdom COME!", "./resources/Font/FreeSans.ttf", 30, 10, 50, YELLOW, RED, GREEN, BLUE); 
	...
	ModelAndAnimation testAnimModel = CreateAnimationModel(
		"./resources/3D/tutorialCharachter0.m3d",
